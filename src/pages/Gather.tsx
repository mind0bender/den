...
import RemoteDesignTeam from "../assets/remote_design_team.svg";
          ...
          <div className={`max-w-lg w-full flex flex-col gap-4`}>
            <div className={`text-4xl font-semibold`}>
              ...
              <div className={`text-2xl py-2`}>
                and discover new possibilities for collaboration and
                communication
              </div>
            </div>
          </div>
        ...
        <div className={`max-w-lg w-full flex flex-col gap-4`}>
          <div
            ...
            <img
              draggable={"false"}
              className={`max-w-xs`}
              src={RemoteDesignTeam}
              alt="Online Collaboration"
            />
          </div>
          <div className={`text-lg font-bold`}>
            Join the <span title={`group of lions`}>Pride</span> of developers
            at Den Gathering -
          </div>
          where collaboration and communication are taken to new heights.
          Discover the power of real-time communication with our platform and
